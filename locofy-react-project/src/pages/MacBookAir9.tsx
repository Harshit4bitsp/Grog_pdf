...
const MacBookAir9: FunctionComponent = () => {
  return (
    <div className="relative bg-snow-200 w-full overflow-hidden flex flex-col pt-[33px] pb-[60px] pr-9 pl-[79px] box-border items-center justify-center gap-[38px] text-center text-[14.25px] text-maroon-100 font-rubik">
      ...
      <div className="flex flex-row items-center justify-center gap-[35px]">
        ...
        <div className="flex flex-col items-start justify-center gap-[27px] text-sm">
          <div className="flex flex-row items-center justify-center gap-[24px]">
            <div className="rounded-4xs bg-maroon-200 overflow-hidden flex flex-row py-[17px] px-[41px] items-center justify-center gap-[10px] border-[1px] border-solid border-maroon-100">
              <img
                className="relative w-[21.89px] h-[21.87px]"
                alt=""
                src="/group-6.svg"
              />
              <div className="relative font-medium">Untitles.CSV</div>
            </div>
            <div className="rounded-4xs bg-maroon-200 overflow-hidden flex flex-row py-[17px] px-[41px] items-center justify-center border-[1px] border-solid border-maroon-100">
              <img
